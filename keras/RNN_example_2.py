...
with graph.as_default():
    with tf.Session() as sess:
        ...
        restore_graph = tf.get_default_graph()
        X = restore_graph.get_tensor_by_name('X: 0')
        Y = restore_graph.get_tensor_by_name('Y: 0')
        # print(X.get_shape())
        # print(Y.get_shape())
        loss_op = restore_graph.get_tensor_by_name('loss_op: 0')
        accuracy = restore_graph.get_tensor_by_name('accuracy: 0')
        train_op = restore_graph.get_operation_by_name('train_op')
